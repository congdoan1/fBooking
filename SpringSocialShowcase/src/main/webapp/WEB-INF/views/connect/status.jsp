...
<c:forEach var="providerId" items="${providerIds}">
	...
	<div class="accountConnection">
		...
		<h4>
			<img src="<c:url value="${iconUrl}" />" width="36" height="36" />${providerDisplayName}</h4>
		...
		<p>
			...
			Click <a href="<c:url value="/connect/${providerId}" />">here</a> to
			manage your ${providerDisplayName} connection.
		</p>
	</div>
</c:forEach>